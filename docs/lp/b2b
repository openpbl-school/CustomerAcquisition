MODELO DE PROPOSTA (texto para aprovação)
...
...
...
Seção: Descrição do projeto de capacitação
...
…
RASCUNHO
À medida que mundo se torna mais globalizado, dinâmico e automatizado, novas e melhores técnicas são desenvolvidas em períodos cada vez mais curtos e precisam ser constantemente atualizadas. 
